...
public class Constants {
   ...
   public static final String NEED_CONNECTION =
         "no connection to serengeti server, please connect first.";
   ...
   public static String PARAM_NOT_SPECIFIED =
         " is not specified, please check it.";
   public static String PARAM_NOT_EXISTED =
         " cannot be found. Please add it first.";
   public static String PARAM_NOT_CONTAIN_HORIZONTAL_LINE =
         " cannot contain '-'.";
