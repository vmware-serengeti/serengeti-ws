...
public class ClusterCommandsTest extends MockRestServer {
   ...
   private ClusterRead getClusterResponseForCreate() {
    ...
    public void testCreateCluster() throws Exception {
       ...
       clusterCommands.createCluster("cluster1", null, "HADOOP", null, null, null, null, null, null, null, null, false, false, true, false, "", null, null, null, false);
    ...
    public void testCreateClusterWithDistroName() throws Exception {
        ...
        clusterCommands.createCluster("cluster1", null, "HADOOP", Constants.DEFAULT_DISTRO, null, null, null, null, null, null, null, false, false, true, false, "", null, null, null, false);
    ...
    public void testCreateClusterBySpecFile() throws Exception {
       ...
       buildReqRespWithoutReqBody("https://127.0.0.1:8443/serengeti/api/cluster/cluster1WithHadoopSpec", HttpMethod.GET,
             HttpStatus.OK, mapper.writeValueAsString(getClusterResponseForCreate()));
       clusterCommands.createCluster("cluster1WithHadoopSpec", null, null, null, "src/test/resources/hadoop_cluster.json", null, null, null, null, null, null, false, false, true, false, "", null, null, null, false);
       ...
       buildReqRespWithoutReqBody("https://127.0.0.1:8443/serengeti/api/cluster/cluster1WithHBaseSpec", HttpMethod.GET,
             HttpStatus.OK, mapper.writeValueAsString(getClusterResponseForCreate()));
       clusterCommands.createCluster("cluster1WithHBaseSpec", null, null, null, "src/test/resources/hbase_cluster.json", null, null, null, null, null, null, false, false, true, false, "", null, null, null, false);
       ...
       buildReqRespWithoutReqBody("https://127.0.0.1:8443/serengeti/api/cluster/cluster1WithDCSeperationSpec", HttpMethod.GET,
             HttpStatus.OK, mapper.writeValueAsString(getClusterResponseForCreate()));
       clusterCommands.createCluster("cluster1WithDCSeperationSpec", null, null, null, "src/test/resources/data_compute_separation_cluster.json", null, null, null, null, null, null, false, false, true, false, "", null, null, null, false);
       ...
       buildReqRespWithoutReqBody("https://127.0.0.1:8443/serengeti/api/cluster/cluster1WithNameNodeHASpec", HttpMethod.GET,
             HttpStatus.OK, mapper.writeValueAsString(getClusterResponseForCreate()));
       clusterCommands.createCluster("cluster1WithNameNodeHASpec", null, null, null, "src/test/resources/namenode_ha_cluster.json", null, null, null, null, null, null, false, false, true, false, "", null, null, null, false);
   ...
   public void testResumeCreateCluster() throws Exception {
      ...
      buildReqRespWithoutReqBody("https://127.0.0.1:8443/serengeti/api/cluster/cluster1?state=resume",
            HttpMethod.PUT, HttpStatus.NO_CONTENT, "");
      clusterCommands.createCluster("cluster1", null, null, null, null, null, null, null, null, null, null, true, false, true, false, "", null, null, null, false);
      CookieCache.clear();
   }
    ...
    public void testResumeCreateClusterFailure() throws Exception {
        ...
        clusterCommands.createCluster("cluster1", null, "HADOOP", null, null, null, null, null, null, null, null, true, false, true, false, "", null, null, null, false);
        CookieCache.clear();
    }
