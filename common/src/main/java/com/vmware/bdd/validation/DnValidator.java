 ...
 */
public class DnValidator implements ConstraintValidator<DnFormat, String> {

   private Pattern pattern = Pattern.compile(
         "^([a-z][a-z0-9-]*)=(?![ #])(((?![\\\\=\"+,;<>]).)|(\\\\[ \\\\#=\"+,;<>])|(\\\\[a-f0-9][a-f0-9]))*(,([a-z][a-z0-9-]*)=(?![ #])(((?![\\\\=\"+,;<>]).)|(\\\\[ \\\\#=\"+,;<>])|(\\\\[a-f0-9][a-f0-9]))*)*$"
   );

   @Override
   public void initialize(DnFormat dnFormat) {
