...
public class ThumbprintTrustManager implements X509TrustManager {
   private static final Logger logger = Logger
         .getLogger(ThumbprintTrustManager.class);
   ...
   /*
    * Add a thumbprint owned by "owner". If owner is null, keep the thumbprint
    * until it is removed by force.
    */
   ...
   /*
    * Remove a thumbprint owned by "owner". If owner is null, force remove the
    * thumbprint.
    */
    ...
    * 
    * @param cert
    *           the certificate to generate a thumbprint for
