...
More details can be found at [cli/README.md](https://github.com/vmware-serengeti/serengeti-ws/tree/master/cli). Some sample cluster creation specification files can be found at [cli/samples].
