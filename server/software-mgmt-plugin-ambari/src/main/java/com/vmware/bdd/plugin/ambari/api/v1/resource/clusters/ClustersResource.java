...
public interface ClustersResource {
   ...
   @GET
   @Path("/{clusterName}")
   public Response readCluster(@PathParam(Parameters.CLUSTER_NAME) String clusterName);
   ...
   public Response createCluster(@PathParam(Parameters.CLUSTER_NAME) String clusterName, String clusterBlueprint);

   @DELETE
   @Path("/{clusterName}")
   public Response deleteCluster(@PathParam(Parameters.CLUSTER_NAME) String clusterName);
   ...
   public HostComponentsResource getHostComponentsResource(@PathParam(Parameters.CLUSTER_NAME) String clusterName);
