...
public class DefaultSoftwareManagerImpl implements SoftwareManager {
   ...
   public boolean validateConfiguration(ClusterBlueprint blueprint)
     ...
     */
    @Override
    public boolean validateRoles(ClusterCreate cluster, DistroRead distro) throws SoftwareManagementPluginException {
        AuAssert.check(cluster != null && distro != null, "Invalid parameters for validateRoles");
