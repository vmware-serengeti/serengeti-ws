...
public interface SoftwareManager {
   ...
   /**
    * Validate if this node group is scalable or not. Return list of unsupported role names
    * @param group
    * @return
    */
   ...
   /**
    * Plugin has a chance to update infrastructure setting here.
    * Specifically, plugin can set default 
    * @param blueprint
    */
