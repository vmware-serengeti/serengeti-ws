...
public class ClusterManagerException extends BddException {
   ...
   public ClusterManagerException(Throwable cause, String errorId, Object... detail) {
   ...
   public static ClusterManagerException DELETION_NOT_ALLOWED_ERROR(
      ...
      return new ClusterManagerException(null, "CANNOT_DELETE", clusterName, reason);
   }

   public static ClusterManagerException START_NOT_ALLOWED_ERROR(
         String clusterName, String reason) {
      return new ClusterManagerException(null, "CANNOT_START", clusterName, reason);
   }

   public static ClusterManagerException ALREADY_STARTED_ERROR(String clusterName) {
      return new ClusterManagerException(null, "IS_RUNNING", clusterName);
   }

   public static ClusterManagerException STOP_NOT_ALLOWED_ERROR(String clusterName,
         String reason) {
      return new ClusterManagerException(null, "CANNOT_STOP", clusterName, reason);
   }

   public static ClusterManagerException ALREADY_STOPPED_ERROR(String clusterName) {
   ...
   public static ClusterManagerException UPDATE_NOT_ALLOWED_ERROR(
         String clusterName, String reason) {
      return new ClusterManagerException(null, "CANNOT_UPDATE", clusterName, reason);
   }

   public static ClusterManagerException NOGEGROUP_NOT_FOUND_ERROR(String nodeGroupName) {
      return new ClusterManagerException(null, "NODEGROUP_NOT_FOUND", nodeGroupName);
   }
