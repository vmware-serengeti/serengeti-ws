...
public interface JobConstants {
   ...
   public static final String EXPAND_CLUSTER_JOB_NAME = "expandClusterJob";
   ...
   public static final String CLUSTER_USED_IP_JOB_PARAM = "clusterUsedIpSets";
   ...
   String FORCE_CLUSTER_OPERATION_IGNORE_EXCEPTION = "The above error is ignored because the force flag is set.";
}
