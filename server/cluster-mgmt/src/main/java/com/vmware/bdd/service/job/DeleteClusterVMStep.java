...
public class DeleteClusterVMStep extends TrackableTasklet {
   ...
   public RepeatStatus executeStep(ChunkContext chunkContext,
      ...
      boolean success = clusteringService.deleteCluster(clusterName, statusUpdator);
      putIntoJobExecutionContext(chunkContext, JobConstants.CLUSTER_DELETE_VM_OPERATION_SUCCESS, success);
