...
public class ExpandClusterEnableLdapForNewNodesStep extends EnableLdapForNewNodesStep {
   private static final Logger logger = Logger.getLogger(ExpandClusterEnableLdapForNewNodesStep.class);
