...
public class GenerateHostnameStep extends TrackableTasklet {
   ...
   public RepeatStatus executeStep(ChunkContext chunkContext, JobExecutionStatusHolder jobExecutionStatusHolder) throws Exception {
      ...
      generateHostnameSerivce.generateHostnameForNodes(clusterName, statusUpdator);

      return RepeatStatus.FINISHED;
   }

   public IGenerateHostnameService getGenerateHostnameSerivce() {
      return generateHostnameSerivce;
   }

   public void setGenerateHostnameSerivce(
         IGenerateHostnameService generateHostnameSerivce) {
