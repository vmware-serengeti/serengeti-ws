...
public class AuroraException extends RuntimeException {
   ...
   private static org.apache.commons.configuration.Configuration init() {
      ...
      try {
         String errmsgfile =
               Configuration.getString("cms.errmsg_file",
                     "aurora-errmsg.properties");
   ...
   protected AuroraException(Throwable cause, String section, String errorId,
         Object... args) {
   ...
   /**
    * Check if the given exception is in the appropriate form for the UI. If
    * not, we wrap it in AuroraException.
    * 
    * @param exception
    *           -- the original exception.
    * @return the original exception, if it is in the appropriate form for the
    *         UI (either an AuroraException or a Spring's
    *         AccessDeniedException). Otherwise, return this exception wrapped
    *         in AuroraException.INTERNAL.
    */
   ...
   /**
    * This exception is designed to be thrown only when initializing Aurora web
