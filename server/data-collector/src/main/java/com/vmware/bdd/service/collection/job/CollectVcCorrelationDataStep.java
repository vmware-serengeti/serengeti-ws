...
public class CollectVcCorrelationDataStep extends TrackableTasklet {
   ...
   public RepeatStatus executeStep(ChunkContext chunkContext,
      ...
      sendVcCorrelationData(periodCollectionService.collectData(DataObjectType.VC_CORRELATION));
      return RepeatStatus.FINISHED;
   }

   private void sendVcCorrelationData (Map<String, Map<String, ?>> data) {
